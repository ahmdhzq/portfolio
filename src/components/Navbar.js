...
const Navbar = () => {
    ...
    return (<>
        <div className="fixed container top-4 left-1/2 -translate-x-1/2 z-50">
            <div className="bg-bg-card/30 backdrop-blur-lg text-text-light py-2.5 px-6 rounded-full shadow-lg border border-white/10">
        ...
        <div className="fixed container top-4 left-1/2 -translate-x-1/2 -z-50">
            <div className="bg-bg-card backdrop-blur-lg text-text-light py-6 px-6 rounded-full shadow-lg border border-white/10 ">
            </div>
        </div>
    </>
    );
